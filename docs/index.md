...
The release archives contains the current LibreDOS Kernel, also
known as DOS-C, originally written by Pasquale J. Villani.

The LibreDOS Kernel is available from https://github.com/FDOS/kernel/
(formally http://libredos.sourceforge.net/ ).
...
even earlier archive of old (Bugzilla) items is at www.libredos.org/bugzilla/ )
